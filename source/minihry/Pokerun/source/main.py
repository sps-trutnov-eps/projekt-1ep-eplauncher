...
class Hrac(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.hrac = pygame.image.load("Files/hrac.png") 
        self.hrac_skok = pygame.image.load("Files/skok.png")
...
class Prekazky(pygame.sprite.Sprite):
    def __init__(self, type):
        super().__init__()
        if type == "Pokemon1":
            Pokemon1 = pygame.image.load("Files/angry_anton.png")
            Pokemon1b = pygame.image.load("Files/run_angry_anton.png")
            self.pict = [Pokemon1, Pokemon1b]
            y_pos = 300
        else:
            Pokemon2 = pygame.image.load("Files/redbird.png")
            Pokemon2b = pygame.image.load("Files/rotflugzeug.png")
...
class Bonus(pygame.sprite.Sprite):
    def __init__(self, type):
        super().__init__()
        if type == "Bonus1":
            bonus_image1 = pygame.image.load("Files/Anton.png")
            bonus_image1b = pygame.image.load("Files/running_anton.png")
            self.pict = [bonus_image1, bonus_image1b]
            y_pos = 300
        else:
            bonus_image2 = pygame.image.load("Files/greenbird.png")
            bonus_image2b = pygame.image.load("Files/flugzeug.png")
...
#files
obloha = pygame.image.load("Files/city_.png")
zeme = pygame.image.load("Files/ground.png")
...
while True:
    ...
    if hra:
        ...
        player = pygame.image.load("Files/hrac_.png")
